...
WAVFileReader::WAVFileReader(const char *file_name) : m_num_channels(2), m_sample_rate(44100)
{
    ...
    m_data_bytes = wav_header.data_bytes;
    m_bytes_read = 0;

    m_file.seek(44, SeekSet); // skip to data section
}
...
bool WAVFileReader::finished()
{
    return m_bytes_read >= m_data_bytes;
}
